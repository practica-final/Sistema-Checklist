...
@Queries({
        @Query(
                ...
                value = "SELECT "
                        ...
                        + "ORDER BY apellid ASC, nombre ASC"),
        @Query(
                name = "findByDominioContains", language = "JDOQL",
                value = "SELECT "
                        + "FROM domainapp.modules.simple.dominio.vehiculo.Vehiculo "
                        + "WHERE domino.indexOf(:dominio) >= 0 "),
        @Query(
        ...
        @Query(
                name = "findByDominioAndEstado", language = "JDOQL",
                value = "SELECT "
                        + "FROM domainapp.modules.simple.dominio.vehiculo.Vehiculo "
                        + "WHERE dominio == :dominio && estado == :estado "
                        + "ORDER BY marca ASC, modelo ASC")
})
...
public class Vehiculo implements Comparable<Vehiculo>, ObservadorGeneral {
    ...
    public String RepoVencimientoVtv() {
        return this.vencimientoVtv.toString("dd-MM-yyyy");
    }
    ...
    public String default23Update() {return getAnyo();}
